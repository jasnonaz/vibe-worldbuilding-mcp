...
def build_entry_file_path(world_path: Path, taxonomy: str, entry_name: str, extension: str = ".md") -> Path:
...
def build_taxonomy_overview_path(world_path: Path, taxonomy: str, extension: str = ".md") -> Path:
